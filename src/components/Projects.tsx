    ...
    <ul className="grid gap-6 py-12 text-lg md:grid-cols-2 md:gap-x-12 lg:grid-cols-3">
      {allProjects.map((project) => {
        return (
          <li
            key={project.title}
            className="bg-backgroundItem relative rounded-lg pb-4 shadow-xl"
          >
            <Image
              src={project.image}
            ...
            <hgroup className="px-3 md:top-[58%]">
              ...
              <a
                ...
                className="absolute bottom-0 right-0  -translate-y-1/2 transform"
              >
